...
-- Privilegios sobre secuencias
GRANT USAGE, SELECT, UPDATE ON SEQUENCE travel_k_id_travel_seq TO manager_travel;
GRANT USAGE, SELECT, UPDATE ON SEQUENCE travel_k_user_cc_seq TO manager_travel;
GRANT USAGE, SELECT, UPDATE ON SEQUENCE travel_k_series_seq TO manager_travel;
GRANT USAGE, SELECT, UPDATE ON SEQUENCE travel_k_id_bicycle_seq TO manager_travel;
