...
/*  Created On : 19-nov.-2025 8:08:52 a. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	k_id_travel integer NULL	-- Llave foranea que viena desde viaje.
)
;

CREATE TABLE email_verification
(
	k_id_email_verification serial NOT NULL,	-- Llave primaria de la verificacion de email.
	n_otp_hash varchar(255) NOT NULL,	-- Valor Hash del otp que se dio al usuario para hacer su verificacion.
	f_expires_at timestamp without time zone NOT NULL,	-- Fecha en la que expira el codigo.
	t_consumed boolean NOT NULL   DEFAULT false,	-- Estado del codigo.
	f_created_at timestamp without time zone NOT NULL   DEFAULT NOW(),	-- Fecha de cracion del codgio
	k_user_cc integer NOT NULL	-- Llave foranea del usario que solicito la verificacion.
)
;
...
(
	...
	f_activation_date timestamp without time zone NULL,
...
(
	k_id_payment_method varchar(10) NOT NULL,	-- Llave primaria del metodo de pago.
	t_card_type varchar(10) NOT NULL,	-- Tipo de tajeta del Usuario.
	v_number varchar(16) NOT NULL,	-- Numero de tarjeta del usuario.
	f_expiration_date date NOT NULL,	-- Fecha de expiracion de la tarjeta del usuario.
	n_owner_name varchar(50) NOT NULL,	-- Nombre del titular de la tarjeta.
	v_balance numeric(9) NULL,	-- Saldo de la cuenta del usuario.
	k_user_cc integer NOT NULL	-- Llave foranea del usuario..
)
;
...
COMMENT ON TABLE email_verification
	IS 'Esta es la tabla encargada de guardar todos los enviaos de Codigo OTP para la verificacion de las cuentas via Email.'
;

COMMENT ON COLUMN email_verification.k_id_email_verification
	IS 'Llave primaria de la verificacion de email.'
;

COMMENT ON COLUMN email_verification.n_otp_hash
	IS 'Valor Hash del otp que se dio al usuario para hacer su verificacion.'
;

COMMENT ON COLUMN email_verification.f_expires_at
	IS 'Fecha en la que expira el codigo.'
;

COMMENT ON COLUMN email_verification.t_consumed
	IS 'Estado del codigo.'
;

COMMENT ON COLUMN email_verification.f_created_at
	IS 'Fecha de cracion del codgio'
;

COMMENT ON COLUMN email_verification.k_user_cc
	IS 'Llave foranea del usario que solicito la verificacion.'
;
...
COMMENT ON COLUMN payment_method.k_id_payment_method
	IS 'Llave primaria del metodo de pago.'
;

COMMENT ON COLUMN payment_method.t_card_type
	IS 'Tipo de tajeta del Usuario.'
;

COMMENT ON COLUMN payment_method.v_number
	IS 'Numero de tarjeta del usuario.'
;

COMMENT ON COLUMN payment_method.f_expiration_date
	IS 'Fecha de expiracion de la tarjeta del usuario.'
;

COMMENT ON COLUMN payment_method.n_owner_name
	IS 'Nombre del titular de la tarjeta.'
;

COMMENT ON COLUMN payment_method.v_balance
	IS 'Saldo de la cuenta del usuario.'
;

COMMENT ON COLUMN payment_method.k_user_cc
	IS 'Llave foranea del usuario..'
;
