...
(
	...
	k_user_cc integer NOT NULL -- no serial, references users
)
;
...
(
	k_id_travel serial NOT NULL,
	f_request_date timestamp without time zone NULL,
	k_user_cc integer NOT NULL, -- no serial
	k_series serial NOT NULL,
	k_id_bicycle serial NOT NULL
)
;
...
CREATE TABLE users
(
	k_user_cc integer NOT NULL, -- Provided citizen ID (cedula), no autoincrement sequence
	n_username varchar(50) NOT NULL,
	n_hashed_password varchar(255) NOT NULL,
	n_user_first_name varchar(50) NOT NULL,
	n_user_second_name varchar(50) NULL,
	n_user_first_lastname varchar(50) NOT NULL,
	n_user_second_lastname varchar(50) NULL,
