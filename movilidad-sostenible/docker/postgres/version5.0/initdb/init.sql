...
/*  Created On : 23-nov.-2025 7:59:50 p. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	t_cctv_sate boolean NOT NULL   DEFAULT true	-- Es el campo encargado de dar verificacion si el CCTV esta activo y funcional
)
;
...
COMMENT ON COLUMN station.t_cctv_sate
