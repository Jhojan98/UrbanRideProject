...
/*  Created On : 23-nov.-2025 8:16:00 a. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	k_id_travel serial NULL	-- Llave foranea que viena desde viaje.
)
;
...
(
	...
	k_id_station serial NULL
)
;

CREATE TABLE payment_method
(
	k_id_payment_method serial NOT NULL,	-- Llave primaria del metodo de pago.
...
ALTER TABLE users
  ADD CONSTRAINT "UNQ_n_user_email" UNIQUE ()
;

ALTER TABLE users
  ADD CONSTRAINT "UNQ_n_username" UNIQUE ()
;
