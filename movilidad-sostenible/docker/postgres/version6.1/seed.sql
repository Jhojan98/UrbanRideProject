...
('B-1001', 1001, 'MECHANIC', 'LOCKED', NOW(), 4.6097, -74.0817, 95.5),
('B-1002', 1002, 'ELECTRIC', 'LOCKED', NOW(), 4.7110, -74.0721, 80.0),
('B-1003', 1003, 'MECHANIC', 'LOCKED', NOW(), 6.2092, -75.5712, 45.0),
('B-1004', 1004, 'MECHANIC', 'UNLOCKED', NOW(), 6.2518, -75.5636, 100.0),
('B-1005', 1005, 'MECHANIC', 'LOCKED', NOW(), 3.4756, -76.5269, 60.0),
('B-1006', 1006, 'ELECTRIC', 'LOCKED', NOW(), 4.6097, -74.0817, 15.0),
('B-1007', 1007, 'MECHANIC', 'LOCKED', NOW(), 4.7110, -74.0721, 88.0),
('B-1008', 1008, 'MECHANIC', 'UNLOCKED', NOW(), 6.2092, -75.5712, 92.0),
('B-1009', 1009, 'ELECTRIC', 'MAINTENANCE', NOW(), 6.2518, -75.5636, 30.0),
('B-1010', 1010, 'MECHANIC', 'ERROR', NOW(), 3.4756, -76.5269, 75.0);

-- 7. Slots
-- Linking slots to stations and some bicycles
INSERT INTO slots (k_id_slot, t_padlock_status, k_id_station, k_id_bicycle) VALUES
('S-001-01', 'LOCKED', 1, 'B-1001'),
('S-001-02', 'LOCKED', 1, 'B-1006'),
('S-001-03', 'UNLOCKED', 1, NULL),
('S-001-04', 'UNLOCKED', 1, NULL),
('S-002-01', 'LOCKED', 2, 'B-1002'),
('S-002-02', 'LOCKED', 2, 'B-1007'),
('S-002-03', 'UNLOCKED', 2, NULL),
('S-003-01', 'LOCKED', 3, 'B-1003'),
('S-003-02', 'UNLOCKED', 3, NULL),
('S-003-03', 'UNLOCKED', 3, NULL),
('S-004-01', 'UNLOCKED', 4, NULL), -- Bike 4 is UNLOCKED (in use?) so not in slot
('S-004-02', 'LOCKED', 4, 'B-1009'),
('S-005-01', 'LOCKED', 5, 'B-1005'),
('S-005-02', 'LOCKED', 5, 'B-1010'),
...
(NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days' + INTERVAL '30 minutes', 'COMPLETED', 'B-1001', 1, 2, 'user-001', 'LAST_MILE'),
(NOW() - INTERVAL '9 days', NOW() - INTERVAL '9 days', NOW() - INTERVAL '9 days' + INTERVAL '45 minutes', 'COMPLETED', 'B-1002', 2, 1, 'user-002', 'LONG_HAUL'),
(NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days' + INTERVAL '15 minutes', 'COMPLETED', 'B-1003', 3, 4, 'user-004', 'LAST_MILE');

-- Active/In-progress trips
INSERT INTO travel (f_required_at, f_started_at, f_ended_at, t_status, k_id_bicycle, k_from_id_station, k_to_id_station, k_uid_user, t_travel_type) VALUES
(NOW() - INTERVAL '20 minutes', NOW() - INTERVAL '15 minutes', NULL, 'IN_PROGRESS', 'B-1004', 4, NULL, 'user-005', 'LAST_MILE'),
(NOW() - INTERVAL '5 minutes', NOW() - INTERVAL '2 minutes', NULL, 'IN_PROGRESS', 'B-1008', 3, NULL, 'user-001', 'LONG_HAUL');

-- Cancelled trips
INSERT INTO travel (f_required_at, f_started_at, f_ended_at, t_status, k_id_bicycle, k_from_id_station, k_to_id_station, k_uid_user, t_travel_type) VALUES
(NOW() - INTERVAL '1 day', NULL, NULL, 'IN_PROGRESS', 'B-1005', 5, NULL, 'user-003', 'LAST_MILE'); -- podria estar cancelado
...
INSERT INTO maintenance (
	...
	('B-1001', 'PREVENTIVO', 320, 'KILOMETRAJE', 'Revisión general y ajuste de frenos', 'PENDING', NOW(), 45.00),
	('B-1003', 'CORRECTIVO', 185, 'ALERTA_IOT', 'Cambio de pastillas de freno y limpieza de transmisión', 'RESOLVED', NOW(), 78.50),
	('B-1006', 'EMERGENCIA', 510, 'USUARIO', 'Reporte de ruido en la suspensión, pendiente revisión final', 'PENDING', NOW(), NULL),
	('B-1009', 'PREVENTIVO', 260, 'TIEMPO', 'Lubricación y chequeo de batería', 'SOLVING', NOW(), 55.25);