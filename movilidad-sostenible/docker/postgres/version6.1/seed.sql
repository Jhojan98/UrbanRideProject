...
INSERT INTO maintenance (
	...
	('MECH-1001', 'PREVENTIVO', 320, 'KILOMETRAJE', 'Revisión general y ajuste de frenos', 'PENDING', NOW(), 45.00),
	('MECH-1003', 'CORRECTIVO', 185, 'ALERTA_IOT', 'Cambio de pastillas de freno y limpieza de transmisión', 'RESOLVED', NOW(), 78.50),
	('ELEC-1006', 'EMERGENCIA', 510, 'USUARIO', 'Reporte de ruido en la suspensión, pendiente revisión final', 'PENDING', NOW(), NULL),
	('ELEC-1009', 'PREVENTIVO', 260, 'TIEMPO', 'Lubricación y chequeo de batería', 'SOLVING', NOW(), 55.25);