...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.complaints_and_claims TO manager_maintenance;
GRANT USAGE, SELECT, UPDATE ON SEQUENCE public.complaints_and_claims_k_id_complaints_and_claims_seq TO manager_maintenance;	
