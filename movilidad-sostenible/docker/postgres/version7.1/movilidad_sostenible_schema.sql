...
(
	...
	k_id_station integer NULL,	-- Identificador único de la estación a la que se le realizó el mantenimiento. Este valor hace
	k_id_lock varchar(50) NULL	-- Identificador único del candado a la que se le realizó el mantenimiento. Este valor hace
